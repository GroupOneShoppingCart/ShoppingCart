...
public class shoppingCart extends HttpServlet {
    ...
    private List<ProDetails> listcuatao = new ArrayList<>();

    public List<ProDetails> getListcuatao() {
        return listcuatao;
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        shopCart.addToCart(pm.FindByID(id));
        listcuatao = shopCart.getCartList();
        session.setAttribute("cart", shopCart);
        session.setAttribute("listcart", listcuatao);
